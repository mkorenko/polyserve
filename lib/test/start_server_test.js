...
suite('startServers', () => {
    suite('replace generated app with optional appMapper argument', () => {
        ...
        test('allows replacing app with parent app', () => __awaiter(this, void 0, void 0, function* () {
            const server = yield start_server_2.startServers({}, (app) => __awaiter(this, void 0, void 0, function* () {
